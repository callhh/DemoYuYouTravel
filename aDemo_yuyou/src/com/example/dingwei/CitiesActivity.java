...
import com.example.CityLocation.City;
import com.example.CityLocation.DBHelper;
import com.example.CityLocation.DatabaseHelper;
import com.example.CityLocation.MyLetterListView;
import com.example.CityLocation.MyLetterListView.OnTouchingLetterChangedListener;
import com.example.CityLocation.PingYinUtil;
...
public class CitiesActivity extends Activity implements OnScrollListener,OnClickListener {
	...
	private EditText mEdCitySearchInput;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.cities_tb_imgback).setOnClickListener(this);
		...
		mEdCitySearchInput = (EditText) findViewById(R.id.ed_city_input);
		tv_noresult = (TextView) findViewById(R.id.tv_noresult);
		helper = new DatabaseHelper(this);
		
		mEdCitySearchInput.addTextChangedListener(new TextWatcher() {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					UtilsSharePerference.saveCity(getApplicationContext(), allCity_lists.get(position).getName());
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getApplicationContext(),
						...
						.show();
				UtilsSharePerference.saveCity(getApplicationContext(), city_result.get(position).getName());
				Intent data=new Intent(CitiesActivity.this,MainActivity.class);
				startActivity(data);
				finish();
			}
...
//		option.setPoiNumber(3);
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation arg0) {
			...
			adapter.notifyDataSetChanged();
			//sp记录定位城市；
			UtilsSharePerference.saveCity(CitiesActivity.this, currentCity);
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								.show();
						UtilsSharePerference.saveCity(getApplicationContext(), city_history.get(position));
						Intent data=new Intent(CitiesActivity.this,MainActivity.class);
						startActivity(data);
						finish();
					}
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								Toast.LENGTH_SHORT).show();
						UtilsSharePerference.saveCity(getApplicationContext(), city_hot.get(position).getName());
						Intent data=new Intent(CitiesActivity.this,MainActivity.class);
						startActivity(data);
						finish();
					}
...
//			overlay.setVisibility(View.VISIBLE);   //不需要让 overlay一直显示
			handler.removeCallbacks(overlayThread);
			// 延迟一秒后执行，让overlay为不可见
			handler.postDelayed(overlayThread, 1000);
		}
