...
public class HomeMoviceTicketActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_home_movice_ticket);
		initUI();
		initWebView();
	}
	...
	public void initWebView()
	{
		...
		mWebView.loadUrl(Constants.Url.HOME_MOVIE_TICKET); // 指定的路径
		mWebView.getSettings().setLayoutAlgorithm(LayoutAlgorithm.SINGLE_COLUMN);// 设置图片自适应浏览器大小
																					// 4.4版本之前有效
