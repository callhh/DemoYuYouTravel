...
public class HomeBannerActivity extends Activity
{
	...
	public void initWebView()
	{
		...
		String bannerUrl = intent.getStringExtra(Constants.IntentKey.BANNER_POSITION_URL);
...
//		mWebView.loadDataWithBaseURL(null, hotDetail.getArticle().getContent(), "text/html", "utf-8", null);
		...
		mWebView.loadUrl(bannerUrl); //指定的路径
