...
import com.example.sample.fragment.ProductTourFragment;
...
public class ProductTourActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sp1 = getSharedPreferences("ceshi", 0);
		edit1 = sp1.edit();
		isFirst1 = sp1.getBoolean("remember1", true);
		...
		skip.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				if (isFirst1)
				{
					edit1.putBoolean("remember1", false);
					edit1.commit();
					Intent intent = new Intent(getApplication(), CitiesActivity.class);
...
//				endTutorial();
		...
		pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener()
		{
			...
			public void onPageSelected(int position)
			{
				...
				{
//					// 引导页跳转到最后一个页面 在滑动 就是mainActivity
	...
	public class CrossfadePageTransformer implements ViewPager.PageTransformer
	{
		...
		public void transformPage(View page, float position)
		{
			...
			} else
			{
				...
				// ViewHelper.setTranslationX(text_content,pageWidth *
				// position);
			...
			//
			// if(object8 != null){
			// ViewHelper.setTranslationX(object8,(float)(pageWidth/1.5 *
			// position));
			// }
			...
			// if(object12 != null){
			// ViewHelper.setTranslationX(object12,(float)(pageWidth/1.3 *
			// position));
			// }
			//
			// if(object13 != null){
			// ViewHelper.setTranslationX(object13,(float)(pageWidth/1.8 *
			// position));
			// }

			// if(object3 != null){
			// ViewHelper.setTranslationX(object3,(float)(pageWidth/1.2 *
			// position));
			// }
		}
	}
