...
public class DestinationHotCtiyActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_destination_hot_ctiy);
		initUI();
		initWebView();
	}
	...
	private void initUI()
	{
		...
		mBar = (ProgressBar) findViewById(com.example.sample.R.id.progressbar_destina_hotcity);
		mActionbarTitle = (TextView) findViewById(R.id.tv_actionbar_title);
		mActionbarTitle.setText("厦门");
	...
	public void initWebView()
	{
		...
		mWebView = (WebView) findViewById(R.id.webview_destina_hotcity); 
...
//		settings.setJavaScriptCanOpenWindowsAutomatically(true); // 支持JavaScript
		...
		mWebView.loadUrl(Constants.Url.DESTINATION_XIAMEN); //指定的路径
