...
public class HomeViewPagerIndicator2 extends View
{
	...
	public HomeViewPagerIndicator2(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initPaint(); // 初始化画笔
	}
	...
	private void initPaint()
	{
		...
		mPaintfore.setColor(Color.parseColor("#268fff")); //选中的状态颜色
		mPaint_bg = new Paint(Paint.ANTI_ALIAS_FLAG);
		mPaint_bg.setColor(Color.GRAY); // 灰色背景

		mPaintStroke = new Paint(Paint.ANTI_ALIAS_FLAG);
		mPaintStroke.setColor(Color.parseColor("#ff8300")); // 外环颜色 蓝
