...
public class NearbyDestinationList {
    ...
    @Expose
    private List<ModuleContentList____> moduleContentList = new ArrayList<ModuleContentList____>();
     ...
     */
    public List<ModuleContentList____> getModuleContentList() {
     ...
     *     The moduleContentList
     */
    public void setModuleContentList(List<ModuleContentList____> moduleContentList) {
