...
public class FreshPlayWayList {
    ...
    @Expose
    private List<ModuleContentList__> moduleContentList = new ArrayList<ModuleContentList__>();
     ...
     */
    public List<ModuleContentList__> getModuleContentList() {
     ...
     *     The moduleContentList
     */
    public void setModuleContentList(List<ModuleContentList__> moduleContentList) {
